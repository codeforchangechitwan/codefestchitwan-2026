/*
 * lucide-react no longer ships third-party brand logos, so the two social
 * marks we need are inlined here. Both use `currentColor` and match the
 * 24×24 grid of the lucide icons they sit beside.
 */
